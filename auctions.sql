...
create table posts(end_date date, end_time timestamp, min_price float, login varchar(25), auction_number int, primary key (login, auction_number), foreign key (auction_number) references electronics(auction_number), foreign key (login) references endUser(login));
...
values (1500, "Apple", "20000", "rose gold", "X", "2020", "20000", "MacBook Air", null, false, 456789, "5000 gbs", "", "7000 GB", "1080x1980", "20 dB", "25 Hz", false, true, false);
insert into posts 
values ('2021-05-24', "2021-05-24 21:31:10", "1500", "kirbysmash", 456789);
insert into staffMessage values ("kirbysmash", "admin@gmail.com", 78965, "Welcome to your first auction!!!", "You have now finally signed up and can now create and/or participate in your first auction! Enjoy your time!");